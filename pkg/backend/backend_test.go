...
func (m *mockBackend) Chat(ChatRequest) (*ChatResponse, error) { return nil, nil }
func (m *mockBackend) ChatStream(ChatRequest) (io.ReadCloser, error) {
	return nil, nil
}
func (m *mockBackend) LoadModel(model string) error     { return nil }
func (m *mockBackend) UnloadModel(model string) error   { return nil }
func (m *mockBackend) IsRunning(model string) (bool, error) {
	return false, nil
}
